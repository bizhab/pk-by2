...
class _AbsensiMandiriPageState extends State<AbsensiMandiriPage> {
  ...
  Future<void> _cekLokasi() async {
    ...
    if (mounted) setState(() { _lokasiResult = result; _cekingLokasi = false; });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Absen: $matkul — Kelas $namaKelas', style: const TextStyle(fontSize: 16)),
        leading: const BackButton(color: Colors.white),
      ),
      body: Center( // Center content to look good on desktop
        child: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 600), // Max lebar 600
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if (_cekingLokasi)
                    ...
                    if (_lokasiResult!.jarak > 0) ...[
                      ...
                      Row(children: [
                        Expanded(child: _InfoChip(label: 'Jarak Anda', value: _lokasiResult!.jarakDisplay)),
                        const SizedBox(width: 10),
                        Expanded(child: _InfoChip(label: 'Radius Max', value: '${_lokasiResult!.radius.toInt()} m')),
                      ]),
                    ],
                  ],
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        showError(context, 'Gagal absen: $e');
      }
    }
  }
}
